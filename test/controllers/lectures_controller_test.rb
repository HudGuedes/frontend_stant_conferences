...
class LecturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lecture" do
    assert_difference("Lecture.count") do
      post lectures_url, params: { lecture: { duration: @lecture.duration, name: @lecture.name } }
    end
  ...
  test "should update lecture" do
    patch lecture_url(@lecture), params: { lecture: { duration: @lecture.duration, name: @lecture.name } }
